...
EchoValhallaAudioProcessorEditor::EchoValhallaAudioProcessorEditor(EchoValhallaAudioProcessor& p)
...
EchoValhallaAudioProcessorEditor::~EchoValhallaAudioProcessorEditor()
{
    juce::LookAndFeel::setDefaultLookAndFeel(nullptr);
}

void EchoValhallaAudioProcessorEditor::paint(juce::Graphics& g)
{
...
void EchoValhallaAudioProcessorEditor::resized()
{
...
void EchoValhallaAudioProcessorEditor::setupKnob(juce::Slider& slider, juce::Label& label, const juce::String& labelText, const juce::String& paramID)
{
